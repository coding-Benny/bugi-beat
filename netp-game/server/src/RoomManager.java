...
public class RoomManager {
	private static List<GameRoom> roomList = new ArrayList<GameRoom>();	// 방의 리스트
	 ...
	 * 방을 생성함과 동시에 방장으로 임명
	 */
	public static GameRoom createRoom(GameUser owner, String title) {
		int roomID = atomicInteger.incrementAndGet();
		
		GameRoom gameRoom = new GameRoom(roomID, owner, title);
